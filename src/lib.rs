...
impl Game {
    ...
    pub fn get(&self, p: Location) -> &Cell {
        &self.cells[p.x][p.y]
    }

    pub fn set_live(&mut self, p: Location) {
...
mod tests {
    ...
    fn test_new_game_size() {
        ...
        assert_eq!(*game.get(Location::new(99, 99)), Cell::Dead);
    }

    #[test]
    fn set_live_cell() {
        let mut game = Game::new(Size(100));
        game.set_live(Location::new(50, 50));
        assert_eq!(*game.get(Location::new(50, 50)), Cell::Live);
    }
    ...
    fn any_live_cell_with_fewer_than_two_live_neighbours_dies_as_if_caused_by_under_population() {
        ...
        game.set_live(Location::new(50, 50));
        game.tick();
        assert_eq!(*game.get(Location::new(50, 50)), Cell::Dead);
    }
    ...
    fn any_live_cell_with_two_live_neighbours_lives_on_to_the_next_generation() {
        let mut game = Game::new(Size(100));
        game.set_live(Location::new(50, 50));
        game.set_live(Location::new(49, 50));
        game.set_live(Location::new(51, 50));
        game.tick();
        assert_eq!(*game.get(Location::new(50, 50)), Cell::Live);
    }
    ...
    fn any_live_cell_with_three_live_neighbours_lives_on_to_the_next_generation() {
        ...
        game.set_live(Location::new(49, 50));
        game.set_live(Location::new(51, 50));
        game.set_live(Location::new(50, 51));
        game.tick();
        assert_eq!(*game.get(Location::new(50, 50)), Cell::Live);
    }
    ...
    fn any_live_cell_with_more_than_three_live_neighbours_dies_as_if_by_overcrowding() {
        ...
        game.set_live(Location::new(50, 50));
        game.set_live(Location::new(49, 50));
        game.set_live(Location::new(50, 49));
        game.set_live(Location::new(51, 50));
        game.set_live(Location::new(50, 51));
        game.tick();
        assert_eq!(*game.get(Location::new(50, 50)), Cell::Dead);
    ...
    fn real_case_scenario() {
        ...
        let mut game = Game::new(Size(100));
        for _ in 0..50 {
            let p = Location::new(rng.random_range(0..100), rng.random_range(0..100));
            game.set_live(p);
        }
        for _ in 0..5 {
            game.tick();
